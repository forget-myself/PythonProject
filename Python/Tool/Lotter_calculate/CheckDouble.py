...
if __name__ == '__main__':
    first_prize = [0, 7421868]
    second_prize = [0, 137086]
    third_prize = [0, 10000]
    four_prize = [0, 3000]
    five_prize = [0, 300]
    six_prize = [0, 200]
    ...
    write_numbers_front = [1, 12, 15, 26, 35]
    write_numbers_back = [10, 11]
    ...
    temp_arr = [0] * all_rows
    a = sheet.cell(0, 1)
    print(sheet.cell(0, 1), type(a), all_rows)
    while start_index < all_rows:
        ...
        if (front_common == 5 and back_common == 2):
            ...
            third_prize[0] += 1
        elif (front_common == 4 and back_common == 2):
            print('no.4', start_index)
            four_prize[0] += 1
        elif ((front_common == 4 and back_common == 1)):
            print('no.5', start_index)
            five_prize[0] += 1
        elif ((front_common == 3 and back_common == 2)):
            print('no.6', start_index)
            six_prize[0] += 1
        elif ((front_common == 4 and back_common == 0)):
            # print('no.7', start_index)
            seven_prize[0] += 1
        elif (front_common == 3 and back_common == 1) or (front_common == 2 and back_common == 2):
            # print('no.8', start_index)
            eight_prize[0] += 1
        elif (front_common == 3 and back_common == 0) or (front_common == 1 and back_common == 2) or \
                (front_common == 2 and back_common == 1) or (back_common == 2):
            # print('no.9', start_index)
            night_prize[0] += 1

        total = \
            first_prize[0] * first_prize[1] + \
            second_prize[0] * second_prize[1] + third_prize[0] * third_prize[1] + \
            four_prize[0] * four_prize[1] + five_prize[0] * five_prize[1] + six_prize[0] * six_prize[1] + \
            seven_prize[0] * seven_prize[1] + night_prize[0] * night_prize[1] + eight_prize[0] * eight_prize[1]
    print('总计金额 :', total)
